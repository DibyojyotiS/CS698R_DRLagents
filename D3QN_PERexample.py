...
from CS698R_DRLagents import D3QN_PER
...
eval_rewards = D3QN_PERagent.evaluateAgent()
...
for i_episode in range(5):
    ...
    for t in range(600):
        env.render()
        action = selectGreedyAction(D3QN_PERagent.dueling_network, torch.tensor([observation], dtype=torch.float32, device=device))
